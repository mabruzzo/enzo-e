...
public:  // interface
  ...
  EnzoMethodInference(int level_base, int level_array, int level_infer,
                      std::string field_group, float overdensity_threshold);
  ...
  virtual std::string name() throw() { return "inference"; }
...
public:  // methods
  ...
  std::string field_group() const { return field_group_; }
...
protected:  // methods
  ...
  void compute_overdensity_(Block* block, char* mask, int nx, int ny, int nz);
  ...
  std::tuple<int, int, int, int, int, int> get_block_portion_(Index index,
                                                              int index_field,
                                                              int ia3[3]);
  ...
  void coarsen_(enzo_float* ac, int mcx, int mcy, int mcz, int ncx, int ncy,
                int ncz, int ecx, int ecy, int ecz, const enzo_float* af,
                int mfx, int mfy, int mfz, int nfx, int nfy, int nfz, int efx,
                int efy, int efz);
