...
public:  // interface
  /// Constructor
  EnzoStopping(int cycle, double time, double seconds, double redshift) throw()
  ...
  EnzoStopping(CkMigrateMessage* m) : Stopping(m), stop_redshift_(0) {}
  ...
  double stop_redshift() const throw() { return stop_redshift_; };
