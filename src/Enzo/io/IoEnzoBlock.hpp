...
class IoEnzoBlock : public IoBlock {
  /// @class    IoEnzoBlock
  /// @ingroup  Enzo
  /// @brief    [\ref Enzo] Class for interfacing between EnzoBlock and Output
  /// objects
...
public:  // interface
  ...
  void meta_value(int index, void** buffer, std::string* name, int* type,
                  int* nxd = 0, int* nyd = 0, int* nzd = 0) throw();

  /// Return the ith data item associated with the EnzoBlock object
  void data_value(int index, void** buffer, std::string* name, int* type,
                  int* nxd = 0, int* nyd = 0, int* nzd = 0) throw();
  ...
  virtual void print(const char* msg) {
    ...
    CkPrintf("DEBUG_IO_ENZO_BLOCK enzo_GridLeftEdge_   %g %g %g\n",
             enzo_GridLeftEdge_[0], enzo_GridLeftEdge_[1],
             enzo_GridLeftEdge_[2]);
    CkPrintf("DEBUG_IO_ENZO_BLOCK enzo_GridDimension_  %d %d %d\n",
             enzo_GridDimension_[0], enzo_GridDimension_[1],
             enzo_GridDimension_[2]);
    CkPrintf("DEBUG_IO_ENZO_BLOCK enzo_GridStartIndex_ %d %d %d\n",
             enzo_GridStartIndex_[0], enzo_GridStartIndex_[1],
             enzo_GridStartIndex_[2]);
    CkPrintf("DEBUG_IO_ENZO_BLOCK enzo_GridEndIndex_   %d %d %d\n",
             enzo_GridEndIndex_[0], enzo_GridEndIndex_[1],
             enzo_GridEndIndex_[2]);
