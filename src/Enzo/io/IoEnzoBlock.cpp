...
IoEnzoBlock::IoEnzoBlock() throw() : IoBlock(), index_enzo_(0) {
...
void IoEnzoBlock::meta_value(int index, void** buffer, std::string* name,
                             int* type, int* nxd, int* nyd, int* nzd) throw() {
...
void IoEnzoBlock::data_value(int index, void** buffer, std::string* name,
                             int* type, int* nxd, int* nyd, int* nzd) throw() {}
...
char* IoEnzoBlock::save_data(char* buffer) const {
  ...
  ASSERT2("IoEnzoBlock::save_data()", "Expecting buffer size %d actual size %d",
