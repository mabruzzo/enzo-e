...
///           given in the file specified by
...
EnzoInitialMergeSinksTest::EnzoInitialMergeSinksTest(
  ...
  ASSERT("EnzoInitialMergeSinksTest", "Error: No particle data found",
         n_particles_ != 0);
...
void EnzoInitialMergeSinksTest::enforce_block(
  ...
  ASSERT("EnzoInitialMergeSinksTest", "Block does not exist", block != NULL);
