...
public:  // interface
  /// Constructor
  EnzoInitialBBTest(int cycle, double time, const double center[3],
  ...
  void enforce_block(Block* block, const Hierarchy* hierarchy) throw();
...
private:  // attributes
  ...
  /// Nominal uniform sound speed of the gas used to initialise the total
  /// specific energy In practice the actual sound speed will be different
  double nominal_sound_speed_;

  /// The angular rotation velocity of the sphere (units are radians per unit
  /// time)
