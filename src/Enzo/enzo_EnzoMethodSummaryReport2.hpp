...
/// @file     enzo_EnzoMethodSummaryReport2.hpp
/// @author   Matthew Abruzzo (matthewabruzzo@gmail.com) 
/// @date     Fri Jan 28 2022
/// @brief    [\ref Enzo] Declaration of EnzoMethodSummaryReport2
///           Application specific Method to print useful diagnostic information

class EnzoMethodSummaryReport2 : public EnzoMethodSummaryReport {
...
public: // interface
  ...
  EnzoMethodSummaryReport2(double density_cloud, double density_wind,
  ...
  PUPable_decl(EnzoMethodSummaryReport2);

  /// Charm++ PUP::able migration constructor
  EnzoMethodSummaryReport2 (CkMigrateMessage *m)
