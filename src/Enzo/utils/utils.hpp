...
bool consistent_cube_cellwidths(enzo_float dx, enzo_float dy,
...
FORCE_INLINE enzo_float squared_mag_vec3D(enzo_float i, enzo_float j,
...
inline enzo_float apply_floor(const enzo_float value, const enzo_float floor) {
  enzo_float out;
#ifdef RAISE_FLOOR_ERROR
  ASSERT("enzo_utils::apply_floor", "DEBUG-MODE ERROR: applying a floor.",
         value >= floor);
  out = value;
#else
