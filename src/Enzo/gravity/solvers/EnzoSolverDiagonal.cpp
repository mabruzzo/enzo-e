...
EnzoSolverDiagonal::EnzoSolverDiagonal(std::string name, std::string field_x,
...
void EnzoSolverDiagonal::apply(std::shared_ptr<Matrix> A,
                               Block* block) throw() {
  Solver::begin_(block);
...
void EnzoSolverDiagonal::compute_(std::shared_ptr<Matrix> A,
                                  Block* block) throw()
//     X = B / diag(A)
{
