...
/// @date     2015-04-02
/// @brief    Implementation of the discrete Diagonal operator
/// EnzoMatrixDiagonal
...
void EnzoMatrixDiagonal::matvec(int id_y, int id_x, Block* block,
                                int g0) throw() {
...
void EnzoMatrixDiagonal::matvec(precision_type precision, void* y, void* x,
                                int g0) throw() {
...
// template <class T>
void EnzoMatrixDiagonal::matvec_(enzo_float* Y, enzo_float* X, int g0) const
    throw() {
