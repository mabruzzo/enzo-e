...
/// @date     2015-04-02
/// @brief    Implementation of the discrete Identity operator
/// EnzoMatrixIdentity
...
void EnzoMatrixIdentity::matvec(int id_y, int id_x, Block* block,
                                int g0) throw() {
...
void EnzoMatrixIdentity::matvec(precision_type precision, void* y, void* x,
                                int g0) throw() {
...
void EnzoMatrixIdentity::matvec_(enzo_float* Y, enzo_float* X, int g0) const
    throw() {
