...
public:  // interface
  /// CHARM++ constructor
  EnzoInitialTurbulence(double density_initial, double pressure_initial,
                        double temperature_initial, double gamma) throw()
      : Initial(),
  ...
  /// Constructor
  EnzoInitialTurbulence(int cycle, double time, double density_initial,
                        double pressure_initial, double temperature_initial,
                        double gamma) throw();
