...
const int EnzoInitialSoup::position_[] = {0,  1,  2,  4,  5,  6,  7,  9,  10,
                                          12, 13, 14, 15, 16, 17, 19, 20, 21,
                                          22, 24, 25, 27, 28, 29, 30, 31};

//======================================================================

EnzoInitialSoup::EnzoInitialSoup(int cycle, double time,
  ...
  ASSERT3("EnzoInitialSoup::EnzoInitialSoup()",
          ...
          (nx == SOUP_IMAGE_NX) && (ny == SOUP_IMAGE_NY));
...
void EnzoInitialSoup::enforce_block(Block* block,
