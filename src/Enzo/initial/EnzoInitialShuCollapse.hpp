...
private:  // attributes
  ...
  /// Instability parameter - sphere is gravitationally unstable if this is
  /// greater than 2.0 Determines density profile.
  ...
  /// Mass of the central sink particle. Ignored is central_sink_exists_ is
  /// false
