...
public:  // interface
  ...
  EnzoFluidFloorConfig(double density_floor, double pressure_floor,
                       double temperature_floor, double metal_mass_frac)
  ...
  double density_dbl_prec() const noexcept {
    ASSERT("EnzoFluidFloorConfig::density_prec",
           "this instance does not hold a density floor", has_density_floor());
    return density_;
  }
