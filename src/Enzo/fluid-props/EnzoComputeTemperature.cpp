...
EnzoComputeTemperature::EnzoComputeTemperature(double density_floor,
...
void EnzoComputeTemperature::compute(Block* block) throw() {
  ...
  enzo_float* t = field.is_field("temperature")
                      ? (enzo_float*)field.values("temperature", i_hist_)
                      : NULL;
...
void EnzoComputeTemperature::compute_(
    Block* block, enzo_float* t, bool recompute_pressure, /* true */
