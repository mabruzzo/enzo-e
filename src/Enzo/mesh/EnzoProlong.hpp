...
public:  // interface
  /// Constructor
  EnzoProlong(std::string method, bool positive, bool use_linear) throw();
  ...
  EnzoProlong(CkMigrateMessage* m)
      : Prolong(m), method_(-1), positive_(1), use_linear_(false) {}
...
protected:  // protected virtual methods
  ...
  virtual int coarse_padding_() const { return 1; }
