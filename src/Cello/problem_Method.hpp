...
class Method : public PUP::able {
  /// @class    Method
  /// @ingroup  Method
  /// @brief    [\ref Method] Interface to an application method / analysis /
...
public:  // virtual functions
  ...
  virtual void compute_resume(Block* block, CkReductionMsg* msg) throw() {
  ...
  double courant() const throw() { return courant_; }

  void set_courant(double courant) throw() { courant_ = courant; }
