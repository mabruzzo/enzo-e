...
PARALLEL_MAIN_BEGIN {
  ...
  unit_assert(count == 3);
  unit_assert(iface[IF(-1, 0, 0)] && iface[IF(-1, 1, 0)] && iface[IF(0, 1, 0)]);
  ...
  unit_assert(count == 2);
  unit_assert(iface[IF(0, 1, 0)] && iface[IF(1, 0, 0)]);
  ...
  unit_assert(count == 7);
  unit_assert(iface[IF(0, -1, 0)] && iface[IF(0, -1, 1)] &&
              iface[IF(0, 0, 1)] && iface[IF(1, -1, 0)] &&
              iface[IF(1, -1, 1)] && iface[IF(1, 0, 0)] && iface[IF(1, 0, 1)]);
  ...
  unit_assert(count == 6);
  unit_assert(iface[IF(-1, -1, 0)] && iface[IF(-1, 0, 1)] &&
              iface[IF(-1, 0, 0)] && iface[IF(0, -1, 0)] &&
              iface[IF(0, -1, 1)] && iface[IF(0, 0, 1)]);
  ...
  unit_assert(count == 3);
  unit_assert(iface[IF(0, 0, -1)] && iface[IF(0, 1, 0)] && iface[IF(1, 0, 0)]);
  ...
  unit_assert(count == 3);
  unit_assert(iface[IF(0, 0, 1)] && iface[IF(0, -1, 1)] && iface[IF(1, 0, 1)]);
