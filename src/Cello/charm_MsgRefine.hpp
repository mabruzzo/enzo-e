...
public:  // interface
  ...
  MsgRefine& operator=(const MsgRefine& data_msg) throw() {
    ...
    CkPrintf("%d %s:%d DEBUG_MSG_REFINE assigning %p = %p\n", CkMyPe(),
             __FILE__, __LINE__, this, &data_msg);
#endif
    return *this;
  }
