    ...
    for (int ib = 0; ib < particle.num_batches(it); ib++) {
      ...
      if (rank == 1) {
        ...
        for (int ip = 0; ip < np; ip++) {
          ...
          double vx =
              vx00 * x1 * y1 + vx10 * x0 * y1 + vx01 * x1 * y0 + vx11 * x0 * y0;
          ...
          double vy =
              vy00 * x1 * y1 + vy10 * x0 * y1 + vy01 * x1 * y0 + vy11 * x0 * y0;
        ...
        for (int ip = 0; ip < np; ip++) {
          ...
          double vx = vx000 * x1 * y1 * z1 + vx100 * x0 * y1 * z1 +
                      vx010 * x1 * y0 * z1 + vx110 * x0 * y0 * z1 +
                      vx001 * x1 * y1 * z0 + vx101 * x0 * y1 * z0 +
                      vx011 * x1 * y0 * z0 + vx111 * x0 * y0 * z0;
          ...
          double vy = vy000 * x1 * y1 * z1 + vy100 * x0 * y1 * z1 +
                      vy010 * x1 * y0 * z1 + vy110 * x0 * y0 * z1 +
                      vy001 * x1 * y1 * z0 + vy101 * x0 * y1 * z0 +
                      vy011 * x1 * y0 * z0 + vy111 * x0 * y0 * z0;
          ...
          double vz = vz000 * x1 * y1 * z1 + vz100 * x0 * y1 * z1 +
                      vz010 * x1 * y0 * z1 + vz110 * x0 * y0 * z1 +
                      vz001 * x1 * y1 * z0 + vz101 * x0 * y1 * z0 +
                      vz011 * x1 * y0 * z0 + vz111 * x0 * y0 * z0;
