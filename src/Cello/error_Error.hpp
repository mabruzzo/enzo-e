...
#define WARNING(F, M)                                                          \
  { cello::message(stdout, "WARNING", __FILE__, __LINE__, F, M); }
#define WARNING1(F, M, A1)                                                     \
  { cello::message(stdout, "WARNING", __FILE__, __LINE__, F, M, A1); }
#define WARNING2(F, M, A1, A2)                                                 \
  { cello::message(stdout, "WARNING", __FILE__, __LINE__, F, M, A1, A2); }
#define WARNING3(F, M, A1, A2, A3)                                             \
  { cello::message(stdout, "WARNING", __FILE__, __LINE__, F, M, A1, A2, A3); }
...
#define ERROR1(F, M, A1)                                                       \
  {                                                                            \
    cello::message(stderr, "ERROR", __FILE__, __LINE__, F, M, A1);             \
    cello::error();                                                            \
  }
#define ERROR2(F, M, A1, A2)                                                   \
  {                                                                            \
    cello::message(stderr, "ERROR", __FILE__, __LINE__, F, M, A1, A2);         \
    cello::error();                                                            \
  }
#define ERROR3(F, M, A1, A2, A3)                                               \
  {                                                                            \
    cello::message(stderr, "ERROR", __FILE__, __LINE__, F, M, A1, A2, A3);     \
    cello::error();                                                            \
  }
#define ERROR4(F, M, A1, A2, A3, A4)                                           \
  {                                                                            \
    cello::message(stderr, "ERROR", __FILE__, __LINE__, F, M, A1, A2, A3, A4); \
    cello::error();                                                            \
  }
...
#define TRACE(M)                                                               \
  { cello::message(stdout, "TRACE", __FILE__, __LINE__, "", M); }
#define TRACE0                                                                 \
  { cello::message(stdout, "TRACE", __FILE__, __LINE__, "", ""); }
#define TRACE1(M, A1)                                                          \
  { cello::message(stdout, "TRACE", __FILE__, __LINE__, "", M, A1); }
#define TRACE2(M, A1, A2)                                                      \
  { cello::message(stdout, "TRACE", __FILE__, __LINE__, "", M, A1, A2); }
#define TRACE3(M, A1, A2, A3)                                                  \
  { cello::message(stdout, "TRACE", __FILE__, __LINE__, "", M, A1, A2, A3); }
...
#define TRACE5(M, A1, A2, A3, A4, A5)                                          \
  {                                                                            \
    cello::message(stdout, "TRACE", __FILE__, __LINE__, "", M, A1, A2, A3, A4, \
                   A5);                                                        \
  }
...
#define TRACE(M)                      /* This space intentionally left blank */
#define TRACE1(M, A1)                 /* This space intentionally left blank */
#define TRACE2(M, A1, A2)             /* This space intentionally left blank */
#define TRACE3(M, A1, A2, A3)         /* This space intentionally left blank */
#define TRACE4(M, A1, A2, A3, A4)     /* This space intentionally left blank */
#define TRACE5(M, A1, A2, A3, A4, A5) /* This space intentionally left blank   \
                                       */
#define TRACE6(M, A1, A2, A3, A4, A5, A6)                                      \
...
#else
#define TRACEPUP /* This space intentionally left blank */
#endif
...
#define DEBUG(M)                                                               \
  { cello::message(stderr, "DEBUG", __FILE__, __LINE__, "", M); }
#define DEBUG0                                                                 \
  { cello::message(stderr, "DEBUG", __FILE__, __LINE__, "", ""); }
#define DEBUG1(M, A1)                                                          \
  { cello::message(stderr, "DEBUG", __FILE__, __LINE__, "", M, A1); }
#define DEBUG2(M, A1, A2)                                                      \
  { cello::message(stderr, "DEBUG", __FILE__, __LINE__, "", M, A1, A2); }
#define DEBUG3(M, A1, A2, A3)                                                  \
  { cello::message(stderr, "DEBUG", __FILE__, __LINE__, "", M, A1, A2, A3); }
...
#define DEBUG5(M, A1, A2, A3, A4, A5)                                          \
  {                                                                            \
    cello::message(stderr, "DEBUG", __FILE__, __LINE__, "", M, A1, A2, A3, A4, \
                   A5);                                                        \
  }
...
#define DEBUG0                        /* This space intentionally left blank */
#define DEBUG(M)                      /* This space intentionally left blank */
#define DEBUG1(M, A1)                 /* This space intentionally left blank */
#define DEBUG2(M, A1, A2)             /* This space intentionally left blank */
#define DEBUG3(M, A1, A2, A3)         /* This space intentionally left blank */
#define DEBUG4(M, A1, A2, A3, A4)     /* This space intentionally left blank */
#define DEBUG5(M, A1, A2, A3, A4, A5) /* This space intentionally left blank   \
                                       */
#define DEBUG6(M, A1, A2, A3, A4, A5, A6)                                      \
  /* This space intentionally left blank */
#define DEBUG7(M, A1, A2, A3, A4, A5, A6, A7)                                  \
...
namespace cello {
extern void message(FILE* fp, const char* type, const char* file, int line,
