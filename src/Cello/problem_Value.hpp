...
public:  // interface
  ...
  Value(Parameters* parameters, const std::string parameter_name) throw();
  ...
  template <class T>
  void evaluate(T* values, double t, int ndx, int nx, double* x, int ndy,
                int ny, double* y, int ndz, int nz, double* z) const throw();
