...
public:  // interface
  ...
  void set_float(std::string parameter, double value) throw();
  /// Assign a value to the logical-valued parameter
  void set_logical(std::string parameter, bool value) throw();
  /// Assign a value to the string-valued parameter
  void set_string(std::string parameter, const char* value) throw();
  ...
  void evaluate_float(std::string parameter, int n, double* result,
                      double* deflt, double* x, double* y, double* z,
                      double t) throw();

  /// Evaluate the logical-valued parameter expression
  void evaluate_logical(std::string parameter, int n, bool* result, bool* deflt,
                        double* x, double* y, double* z, double t) throw();

  /// Evaluate the floating-point valued list element expression
  void list_evaluate_float(int, std::string parameter, int n, double* result,
                           double* deflt, double* x, double* y, double* z,
                           double t) throw();

  /// Evaluate the logical-valued list element expression
  void list_evaluate_logical(int, std::string parameter, int n, bool* result,
...
private:  // functions
  ...
  void monitor_access_(std::string parameter, std::string deflt_string,
                       int index = -1) throw();
  ...
  void new_param_(std::string full_parameter, Param* param) throw();
