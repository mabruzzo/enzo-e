...
PARALLEL_MAIN_BEGIN {
  ...
  for (int iz = 0; iz < n1[2]; iz++) {
    for (int iy = 0; iy < n1[1]; iy++) {
      for (int ix = 0; ix < n1[0]; ix++) {
        ...
        v1[i] = (g1[0] <= ix && ix < n1[0] - g1[0] && g1[1] <= iy &&
                 iy < n1[1] - g1[1] && g1[2] <= iz && iz < n1[2] - g1[2])
                    ? 10
                    : -10;
      }
    }
  ...
  for (int iz = 0; iz < n2[2]; iz++) {
    for (int iy = 0; iy < n2[1]; iy++) {
      for (int ix = 0; ix < n2[0]; ix++) {
        ...
        v2[i] = (g2[0] <= ix && ix < n2[0] - g2[0] && g2[1] <= iy &&
                 iy < n2[1] - g2[1] && g2[2] <= iz && iz < n2[2] - g2[2])
                    ? 20
                    : -20;
      }
    }
  ...
  for (int iz = 0; iz < n3[2]; iz++) {
    for (int iy = 0; iy < n3[1]; iy++) {
      for (int ix = 0; ix < n3[0]; ix++) {
        ...
        v3[i] = (g3[0] <= ix && ix < n3[0] - g3[0] && g3[1] <= iy &&
                 iy < n3[1] - g3[1] && g3[2] <= iz && iz < n3[2] - g3[2])
                    ? 30
                    : -30;
      }
    }
  ...
  for (int iz = 0; iz < n4[2]; iz++) {
    for (int iy = 0; iy < n4[1]; iy++) {
      for (int ix = 0; ix < n4[0]; ix++) {
        ...
        v4[i] = (g4[0] <= ix && ix < n4[0] - g4[0] && g4[1] <= iy &&
                 iy < n4[1] - g4[1] && g4[2] <= iz && iz < n4[2] - g4[2])
                    ? 40
                    : -40;
      }
    }
  ...
  for (int iz = 0; iz < n5[2]; iz++) {
    for (int iy = 0; iy < n5[1]; iy++) {
      for (int ix = 0; ix < n5[0]; ix++) {
        ...
        v5[i] = (g5[0] <= ix && ix < n5[0] - g5[0] && g5[1] <= iy &&
                 iy < n5[1] - g5[1] && g5[2] <= iz && iz < n5[2] - g5[2])
                    ? 50
                    : -50;
      }
    }
  ...
  unit_assert(*((double*)(v3 + n3[0] * n3[1] * n3[2])) ==
              40);  // g4 has no ghosts
