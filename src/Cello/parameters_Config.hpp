...
public:  // attributes
  ...
  std::vector<std::vector<std::string> > adapt_field_list;
  ...
  std::vector<std::vector<std::string> > boundary_field_list;
...
protected:  // functions
  ...
  int read_schedule_(Parameters*, const std::string group);
};
