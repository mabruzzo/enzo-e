...
MethodRefresh::MethodRefresh(std::vector<std::string> field_list,
                             std::vector<std::string> particle_list,
                             int ghost_depth, int min_face_rank,
                             bool all_fields, bool all_particles) noexcept
    : Method(),
      field_list_(),
      particle_list_(),
...
void MethodRefresh::compute(Block* block) throw() { block->compute_done(); }
