...
/// @date     2011-10-06
/// @brief    [\ref Io] Abstract base class for providing access to class data
/// for Output classes
...
public:  // interface
  ...
  Io(CkMigrateMessage* m) : PUP::able(m) { TRACE("Io::Io(CkMigrateMessage*)"); }
...
public:  // interface
  ...
  size_t meta_count() const throw() { return meta_name_.size(); }
