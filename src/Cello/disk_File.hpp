...
public:  // interface
  ...
  File(std::string path, std::string name) throw() : path_(path), name_(name) {}
...
public:  // virtual functions
  ...
  virtual void group_read_meta(void* buffer, std::string name, int* s_type,
                               int* n1 = 0, int* n2 = 0, int* n3 = 0,
                               int* n4 = 0) throw() = 0;
