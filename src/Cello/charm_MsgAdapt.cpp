...
void* MsgAdapt::pack(MsgAdapt* msg) {
  ...
  ASSERT2("MsgAdapt::pack()", "buffer size mismatch %ld allocated %d packed",
...
MsgAdapt* MsgAdapt::unpack(void* buffer) {
  ...
  MsgAdapt* msg = (MsgAdapt*)CkAllocBuffer(buffer, sizeof(MsgAdapt));
...
void MsgAdapt::print(const char* msg) {
  ...
  //  CkPrintf ("%d MSG_ADAPT ic3        %d %d
  //  %d\n",ip,ic3_[0],ic3_[1],ic3_[2]); CkPrintf ("%d MSG_ADAPT of3        %d
  //  %d %d\n",ip,of3_[0],of3_[1],of3_[2]); CkPrintf ("%d MSG_ADAPT level_now
  //  %d\n",ip,level_now_); CkPrintf ("%d MSG_ADAPT level_min
  //  %d\n",ip,level_min_); CkPrintf ("%d MSG_ADAPT level_max
  //  %d\n",ip,level_max_); CkPrintf ("%d MSG_ADAPT can_coarsen
  //  %d\n",ip,can_coarsen_); CkPrintf ("%d \n",ip);
  fflush(stdout);
}
