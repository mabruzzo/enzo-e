...
public:  // interface
  ...
  /// level = +1
  inline void set_padding(int pad) { pad_ = pad; }
  ...
  /// specified block
  bool get_start_stop(int index_start[3], int index_stop[3],
                      BlockType block_intersect, BlockType block_coords,
                      bool lpad);

  bool get_start_size(int index_start[3], int index_size[3],
                      BlockType block_intersect, BlockType block_coords,
                      bool lpad);
...
private:  // methods
  ...
  bool intersect_regions_(int index_min[3], int index_max[3],
