...
public:  // functions
  /// Create an uninitialized ScheduleInterval object with the given file_name
  /// format
  ...
  void set_cycle_interval(int cycle_start, int cycle_step,
                          int cycle_stop) throw();

  /// Set time interval (start, step, stop)
  void set_time_interval(double time_start, double time_step,
                         double time_stop) throw();

  /// Set seconds interval (start, step, stop)
  void set_seconds_interval(double seconds_start, double seconds_step,
