...
public:  // interface
  /// Constructor
  ItNeighbor(Block* block, int min_face_rank, int periodic[3], int n3[3],
             Index index, int neighbor_type, int min_level, int root_level);
  ...
  int face_level() const throw() { return block_->face_level(of3_); }
